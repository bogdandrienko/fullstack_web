...
def twice_value5(val1: float, val2: int = 2) -> int | float:  # функция с типизацией
    result = val1 ** val2
    return result
...
# sorted_peoples1 = sorted(sorted_peoples1, key=lambda x: x["age"], reverse=True)  # меняет исходный объект
print(sorted_peoples1)
