...
list12 = [x for x in range(1, 100+1)]  # [1, 2, 3 ... 100]
...
# пример с условием
list7 = ["P", "p", "p", 5, "p", "P", "p"]
#       # 1 - то, что упадёт #  2 цикл   # условие
...
list9 = [x.strip().lower() for x in list8 if "a" in x]
...
list11 = [["key_1", 1], ["key_2", 2], ["key_3", 3]]
a = [{f"{x[0]}": x[1]} for x in list11]
print(a)  # [{'key_1': 1}, {'key_2': 2}, {'key_3': 3}]
new1 = []
for x in list11:
    new1.append({f"{x[0]}": x[1]})

b = {k: v for k, v in list11}
print(b)  # {'key_1': 1, 'key_2': 2, 'key_3': 3}
# new2 = {}
# for x in list11:
#     new2[x[0]] = x[1]
# for k, v in list11:
